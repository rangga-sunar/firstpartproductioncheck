...
class ROCKET_controller extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('nik') != '') {
            ...
            $this->load->view('user/view_ROCKET');
    ...
    {
        $list = $this->ROCKET_model->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->ROCKET_model->count_all(),
            "recordsFiltered" => $this->ROCKET_model->count_filtered(),
            "data" => $data,
        );
    ...
    {
        $data = $this->ROCKET_model->get_by_id($id);
    ...
    public function ajax_add()
    {
        ...
        if ($this->input->post('partnumber') === '') {
            ...
            $insert = $this->ROCKET_model->save($data);
    ...
    public function ajax_update()
    {
        ...
        $this->ROCKET_model->update(array('id' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }

    public function ajax_delete($id)
    {
        $this->ROCKET_model->delete_by_id($id);
        echo json_encode(array("status" => TRUE));
    ...
    public function do_upload()
    {
        ...
        if ($this->upload->do_upload('filename')) {
            ...
            $where = array('id' => $id);
            $result = $this->ROCKET_model->upload_file($data, $where);
    ...
    public function upload_file()
    {
        ...
        if ($this->upload->do_upload('filename')) {
            ...
            $where = array('id' => $id);
            $this->ROCKET_model->upload_file($data, $where);

            redirect('ROCKET_controller');
        } else {
