...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('CN235_controller/ajax_view') ?>",
                "type": "POST"
            },
    ...
    function delete_data(id) {
        ...
        Swal({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: "<?php echo site_url('CN235_controller/ajax_delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
    ...
    function edit_file(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('CN235_controller/ajax_edit/') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
    ...
    function upload_ajax() {
        ...
        $.ajax({
            url: "<?php echo site_url('CN235_controller/do_upload') ?>",
            type: "POST",
            data: formdata,
            processData: false,
            contentType: false,
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('CN235_controller/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('CN235_controller/ajax_update') ?>";
        }
...
<div class="modal fade" id="modal_form_upload" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="<?php echo base_url(); ?>CN235_controller/upload_file" id="form_upload" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="form-group">
